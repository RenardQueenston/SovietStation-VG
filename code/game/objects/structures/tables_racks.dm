	...
	spawn(2) //So it properly updates when deleting
		...
		if(flipped)
			...
			if (istype(src, /obj/structure/table/reinforced))
				base = "rtable"
			if (istype(src, /obj/structure/table/glasstable))
				base = "glasstab"
...
/obj/structure/table/glasstable
	name = "glass table"
	desc = "Another version of the four legged table. Made by glass."
	icon_state = "glass_table"
	parts = /obj/item/weapon/table_parts/glasstable

/obj/structure/table/glasstable/cultify()
	new /obj/structure/table/woodentable(loc)
	..()
