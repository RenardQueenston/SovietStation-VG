...
/obj/item/weapon/storage/envelope
	name = "envelope"
	desc = "It's a common packaging item, usually made of thin flat material."
	icon = 'icons/obj/enevelope.dmi'
	icon_state = "envelope_s"
	item_state = "envelope_s"
	attack_verb = list("slapped")
	w_class = 1
	max_w_class = 1
	storage_slots = 1
	var/envelope_named = 0
	var/stamps
	var/list/stamped
...
/obj/item/weapon/storage/envelope/attackby(obj/item/weapon/P as obj, mob/user as mob)
	..()
	if(istype(P, /obj/item/weapon/pen) || istype(P, /obj/item/toy/crayon))
		if(envelope_named == 0)
			P:RenameEnvelope(user,src)

			var/image/namepoverlay = image('icons/obj/enevelope.dmi')
			namepoverlay.icon_state = "envelope_named"
			overlays += namepoverlay
			user << "<span class='notice'>You renamed [src].</span>"
			envelope_named = 1
		else
			return
		...
		if((!in_range(src, usr) && loc != user && !( istype(loc, /obj/item/weapon/clipboard) ) && loc.loc != user && user.get_active_hand() != P))
			...
			var/image/stampoverlay = image('icons/obj/enevelope.dmi')
			stampoverlay.icon_state = "envelope_s_[P.icon_state]"
...
/obj/item/weapon/storage/envelope/examine(mob/user)
	..()
	user << "[stamps]"
