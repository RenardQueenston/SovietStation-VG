...
/obj/item/weapon/table_parts/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	if (istype(W, /obj/item/stack/sheet/glass))
		if (W:amount >=2)
			new /obj/item/weapon/table_parts/glasstable( user.loc )
			user << "\blue You added glass to the [name]."
			W:use(2)
			del(src)
		else if (W:amount <2)
			user << "\red You need at leats two glass sheets to do this."
...
/obj/item/weapon/table_parts/glasstable/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if (istype(W, /obj/item/weapon/wrench))
		new /obj/item/stack/sheet/metal( user.loc )
		new /obj/item/stack/sheet/glass( user.loc )
		del(src)

/obj/item/weapon/table_parts/glasstable/attack_self(mob/user as mob)
